...
class Layouter extends Model
{
    protected $table = 'layouter';

    protected $primaryKey = 'id_layouter';
    ...
    public static function generateKodeLayouter(?string $mataPelajaran, ?string $bidangKeahlian, int $idLayouter): string
    {
        return sprintf(
            'L-%s-%s-%03d',
